...
ポテンショメータを取り付けた3Dプリント部品を本体に取り付けます．  


## ポテンショメータの3Dプリント部品への取り付け

ポテンショメータを3Dプリントのマウントに取り付けます．  
ポテンショメータの裏面のピンと3Dプリントのマウントの穴を一致させて重ね，上下の二か所をホットボンドで止めてください．  

!!! warning
    ポテンショメータがついたケーブルと3Dプリントしたマウントは，それぞれブーム・アーム・バケット用があるため，対応する組み合わせで作ってください．  
    間違った組み合わせで作った場合，ケーブルが届かなくなったり，余ったりします．  
    また，取り付ける向きにも注意してください．  

!!! note
    ポテンショメータの裏面のピンと3Dプリントのマウントの穴が上手くはまらない場合は，無理に押し込まずに，穴を広げてください．  
...
ブーム・アーム・バケットの各関節にポテンショメータを貼り付けた3Dプリントのマウントや軸を各関節に取り付けます．  
