...
旋回角は，他の関節と異なり，グラデーション付きテープを貼り付けたリングとフォトリフレクタを用いて推定します．  
...
ここでは，土台となるリング，グラデーション付きテープ，フォトリフレクタ付きのセンサ基板を本体に取り付けます．  
...
![](../images/assem_swing_sensor1.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/assem_swing_sensor2.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }
...
![](../images/assem_swing_ring1.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

これを下部走行体と上部旋回体の間に取り付けます．  
すき間から差し込み，下図のように，リングの内側の凸部と下部走行体の旋回部分の台座の凹部がかみ合い，かつ，リングの耳が下部走行体の左右の中央に来るようにしてください．  

![](../images/assem_swing_ring2.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/assem_swing_ring3.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/assem_swing_ring4.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

両側同様に取り付けたら，下図の斜線の部分に接着剤をつけて左右のリングを接着してください．  
前後共に同様に接着してください．  

![](../images/assem_swing_ring5.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/assem_swing_ring6.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }
...
![](../images/assem_swing_tape1.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }
...
![](../images/assem_swing_tape2.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/assem_swing_tape3.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

最後に，残りの剥離紙も剥がし，リングに貼り付けます．  
印刷サイズが間違っていなければ，グラデーション付きテープは端が少し重なるように貼られ，白と黒が切り替わる位置がちょうど下部走行体の中央に来るはずです．

![](../images/assem_swing_tape4.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }
...
![](../images/assem_swing_attach1.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

上部旋回体の後方の裏面に，フォトリフレクタのユニットを貼り付けます．  
上部旋回体の左右の中央になるようにし，かつ，リングから約1 mm程度離して取り付けてください．   

![](../images/assem_swing_attach2.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/assem_swing_attach3.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }
...
![](../images/wiring_swing1.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

![](../images/wiring_swing2.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }

最後に，裏に通したケーブルのコネクタをフォトリフレクタのユニットに接続します．  
コネクタ付近やケーブルを通した穴付近で，ケーブルをマスキングテープなどで止めておくと，旋回時に引っかかったり，コネクタが抜けたりすることを防止できます．  

![](../images/wiring_swing3.jpg){ style="display:block; margin:0 auto; width:100%; max-width:400px;" }